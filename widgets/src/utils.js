...
export function getRoleLabel(role, english, feminine) {
    const ROLES = {
        ...
        'Contrattista di ricerca': ['Contrattista di ricerca', 'Contrattista di ricerca', 'Research Contract Holder', 'Research Contract Holder'], 
        'Incaricato post-doc': ['Incaricato post-doc', 'Incaricata post-doc', 'Postdoctoral Researcher', 'Postdoctoral Researcher'], 
        'Collaboratore di ricerca': ['Collaboratore di ricerca', 'Collaboratrice di ricerca', 'Research Associate', 'Research Associate'],
